    ...
    <div class="w-full max-w-md rounded-xl border border-blue-200 bg-white p-6 shadow-2xl shadow-blue-500/20 sm:p-7 dark:border-zinc-800 dark:bg-zinc-900 dark:shadow-black/50">
        ...
        <div class="mb-5 flex items-center justify-between gap-4 border-b border-blue-100 pb-4 dark:border-zinc-800">
            ...
            <div class="min-w-0">
                ...
                <p id="comments-task-title" class="mt-1 truncate text-xs text-zinc-500 dark:text-zinc-400">
                    —
                </p>
            </div>
        ...
        {{-- Comment List --}}
        <div id="modal-comments-list" class="mb-4 max-h-60 space-y-3 overflow-y-auto pr-1">
        ...
        <form id="comment-form" class="flex gap-2">
            ...
            <input
                ...
                required
                class="flex-1 rounded-lg border border-blue-200 bg-blue-50/50 px-3 py-2 text-xs text-zinc-900 placeholder-zinc-400 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 dark:border-zinc-700 dark:bg-zinc-800 dark:text-white dark:placeholder-zinc-500"
            >
            <button
                type="submit"
                class="cursor-pointer rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600 px-4 py-2 text-xs font-medium text-white shadow-md shadow-blue-500/30 transition hover:from-blue-700 hover:to-indigo-700"
            >
                Post
            </button>
        </form>
        ...
        <button
            ...
            type="button"
            class="mt-5 w-full rounded-lg border border-blue-200 py-2 text-xs font-medium text-blue-700 transition hover:bg-blue-50 cursor-pointer dark:border-zinc-700 dark:text-zinc-300 dark:hover:bg-zinc-800 dark:hover:text-white"
        >
            Close
        </button>
